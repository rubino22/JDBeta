...
object FixpointSolver {
  ...
  object Solver extends Enumeration {
    ...
    val KleeneSolverThread = Value
    val RoundRobinSolverThread = Value       
    val PriorityWorkListSolverThread = Value
    val WorkListSolverThread = Value
    val HierarchicalOrderingSolverThread = Value
  }
